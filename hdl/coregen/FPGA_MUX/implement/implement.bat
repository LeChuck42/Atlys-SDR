...
xst -ifn xst.scr
move FPGA_MUX_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\FPGA_MUX_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc FPGA_MUX_exdes.ucf FPGA_MUX_exdes

echo 'Running map'
map -timing FPGA_MUX_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm FPGA_MUX_exdes -w routed.ncd routed.v
cd ..

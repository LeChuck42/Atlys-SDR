...
xst -ifn xst.scr
move adc_interface_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\adc_interface_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc adc_interface_exdes.ucf adc_interface_exdes

echo 'Running map'
map -timing adc_interface_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm adc_interface_exdes -w routed.ncd routed.v
cd ..

...
wire [31:0] wb_m2s_or1k_i_flash0_adr;
wire [31:0] wb_m2s_or1k_i_flash0_dat;
wire  [3:0] wb_m2s_or1k_i_flash0_sel;
wire        wb_m2s_or1k_i_flash0_we;
wire        wb_m2s_or1k_i_flash0_cyc;
wire        wb_m2s_or1k_i_flash0_stb;
wire  [2:0] wb_m2s_or1k_i_flash0_cti;
wire  [1:0] wb_m2s_or1k_i_flash0_bte;
wire [31:0] wb_s2m_or1k_i_flash0_dat;
wire        wb_s2m_or1k_i_flash0_ack;
wire        wb_s2m_or1k_i_flash0_err;
wire        wb_s2m_or1k_i_flash0_rty;
...
wire [31:0] wb_m2s_or1k_d_flash0_adr;
wire [31:0] wb_m2s_or1k_d_flash0_dat;
wire  [3:0] wb_m2s_or1k_d_flash0_sel;
wire        wb_m2s_or1k_d_flash0_we;
wire        wb_m2s_or1k_d_flash0_cyc;
wire        wb_m2s_or1k_d_flash0_stb;
wire  [2:0] wb_m2s_or1k_d_flash0_cti;
wire  [1:0] wb_m2s_or1k_d_flash0_bte;
wire [31:0] wb_s2m_or1k_d_flash0_dat;
wire        wb_s2m_or1k_d_flash0_ack;
wire        wb_s2m_or1k_d_flash0_err;
wire        wb_s2m_or1k_d_flash0_rty;
...
wire [31:0] wb_m2s_dbg_flash0_adr;
wire [31:0] wb_m2s_dbg_flash0_dat;
wire  [3:0] wb_m2s_dbg_flash0_sel;
wire        wb_m2s_dbg_flash0_we;
wire        wb_m2s_dbg_flash0_cyc;
wire        wb_m2s_dbg_flash0_stb;
wire  [2:0] wb_m2s_dbg_flash0_cti;
wire  [1:0] wb_m2s_dbg_flash0_bte;
wire [31:0] wb_s2m_dbg_flash0_dat;
wire        wb_s2m_dbg_flash0_ack;
wire        wb_s2m_dbg_flash0_err;
wire        wb_s2m_dbg_flash0_rty;
...
wb_mux
  #(.num_slaves (2),
    ...
    .MATCH_MASK ({32'hf8000000, 32'hff800000}))
 wb_mux_or1k_i
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    ...
    .wbs_adr_o ({wb_ddr2_ibus_adr_o, wb_m2s_or1k_i_flash0_adr}),
    .wbs_dat_o ({wb_ddr2_ibus_dat_o, wb_m2s_or1k_i_flash0_dat}),
    .wbs_sel_o ({wb_ddr2_ibus_sel_o, wb_m2s_or1k_i_flash0_sel}),
    .wbs_we_o  ({wb_ddr2_ibus_we_o, wb_m2s_or1k_i_flash0_we}),
    .wbs_cyc_o ({wb_ddr2_ibus_cyc_o, wb_m2s_or1k_i_flash0_cyc}),
    .wbs_stb_o ({wb_ddr2_ibus_stb_o, wb_m2s_or1k_i_flash0_stb}),
    .wbs_cti_o ({wb_ddr2_ibus_cti_o, wb_m2s_or1k_i_flash0_cti}),
    .wbs_bte_o ({wb_ddr2_ibus_bte_o, wb_m2s_or1k_i_flash0_bte}),
    .wbs_dat_i ({wb_ddr2_ibus_dat_i, wb_s2m_or1k_i_flash0_dat}),
    .wbs_ack_i ({wb_ddr2_ibus_ack_i, wb_s2m_or1k_i_flash0_ack}),
    .wbs_err_i ({wb_ddr2_ibus_err_i, wb_s2m_or1k_i_flash0_err}),
    .wbs_rty_i ({wb_ddr2_ibus_rty_i, wb_s2m_or1k_i_flash0_rty}));

wb_mux
  #(.num_slaves (5),
    .MATCH_ADDR ({32'h20000000, 32'h00000000, 32'h90000000, 32'h91000000, 32'hb0000000}),
    .MATCH_MASK ({32'hf8000000, 32'hff800000, 32'hffffffe0, 32'hfffffffe, 32'hfffffff8}))
 wb_mux_or1k_d
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    ...
    .wbs_adr_o ({wb_m2s_or1k_d_ddr2_dbus_adr, wb_m2s_or1k_d_flash0_adr, wb_m2s_resize_uart0_adr, wb_m2s_resize_gpio0_adr, wb_m2s_resize_spi0_adr}),
    .wbs_dat_o ({wb_m2s_or1k_d_ddr2_dbus_dat, wb_m2s_or1k_d_flash0_dat, wb_m2s_resize_uart0_dat, wb_m2s_resize_gpio0_dat, wb_m2s_resize_spi0_dat}),
    .wbs_sel_o ({wb_m2s_or1k_d_ddr2_dbus_sel, wb_m2s_or1k_d_flash0_sel, wb_m2s_resize_uart0_sel, wb_m2s_resize_gpio0_sel, wb_m2s_resize_spi0_sel}),
    .wbs_we_o  ({wb_m2s_or1k_d_ddr2_dbus_we, wb_m2s_or1k_d_flash0_we, wb_m2s_resize_uart0_we, wb_m2s_resize_gpio0_we, wb_m2s_resize_spi0_we}),
    .wbs_cyc_o ({wb_m2s_or1k_d_ddr2_dbus_cyc, wb_m2s_or1k_d_flash0_cyc, wb_m2s_resize_uart0_cyc, wb_m2s_resize_gpio0_cyc, wb_m2s_resize_spi0_cyc}),
    .wbs_stb_o ({wb_m2s_or1k_d_ddr2_dbus_stb, wb_m2s_or1k_d_flash0_stb, wb_m2s_resize_uart0_stb, wb_m2s_resize_gpio0_stb, wb_m2s_resize_spi0_stb}),
    .wbs_cti_o ({wb_m2s_or1k_d_ddr2_dbus_cti, wb_m2s_or1k_d_flash0_cti, wb_m2s_resize_uart0_cti, wb_m2s_resize_gpio0_cti, wb_m2s_resize_spi0_cti}),
    .wbs_bte_o ({wb_m2s_or1k_d_ddr2_dbus_bte, wb_m2s_or1k_d_flash0_bte, wb_m2s_resize_uart0_bte, wb_m2s_resize_gpio0_bte, wb_m2s_resize_spi0_bte}),
    .wbs_dat_i ({wb_s2m_or1k_d_ddr2_dbus_dat, wb_s2m_or1k_d_flash0_dat, wb_s2m_resize_uart0_dat, wb_s2m_resize_gpio0_dat, wb_s2m_resize_spi0_dat}),
    .wbs_ack_i ({wb_s2m_or1k_d_ddr2_dbus_ack, wb_s2m_or1k_d_flash0_ack, wb_s2m_resize_uart0_ack, wb_s2m_resize_gpio0_ack, wb_s2m_resize_spi0_ack}),
    .wbs_err_i ({wb_s2m_or1k_d_ddr2_dbus_err, wb_s2m_or1k_d_flash0_err, wb_s2m_resize_uart0_err, wb_s2m_resize_gpio0_err, wb_s2m_resize_spi0_err}),
    .wbs_rty_i ({wb_s2m_or1k_d_ddr2_dbus_rty, wb_s2m_or1k_d_flash0_rty, wb_s2m_resize_uart0_rty, wb_s2m_resize_gpio0_rty, wb_s2m_resize_spi0_rty}));
...
wb_mux
 ...
 wb_mux_dbg
   (.wb_clk_i  (wb_clk_i),
    ...
    .wbs_adr_o ({wb_m2s_dbg_ddr2_dbus_adr, wb_m2s_dbg_flash0_adr}),
    .wbs_dat_o ({wb_m2s_dbg_ddr2_dbus_dat, wb_m2s_dbg_flash0_dat}),
    .wbs_sel_o ({wb_m2s_dbg_ddr2_dbus_sel, wb_m2s_dbg_flash0_sel}),
    .wbs_we_o  ({wb_m2s_dbg_ddr2_dbus_we, wb_m2s_dbg_flash0_we}),
    .wbs_cyc_o ({wb_m2s_dbg_ddr2_dbus_cyc, wb_m2s_dbg_flash0_cyc}),
    .wbs_stb_o ({wb_m2s_dbg_ddr2_dbus_stb, wb_m2s_dbg_flash0_stb}),
    .wbs_cti_o ({wb_m2s_dbg_ddr2_dbus_cti, wb_m2s_dbg_flash0_cti}),
    .wbs_bte_o ({wb_m2s_dbg_ddr2_dbus_bte, wb_m2s_dbg_flash0_bte}),
    .wbs_dat_i ({wb_s2m_dbg_ddr2_dbus_dat, wb_s2m_dbg_flash0_dat}),
    .wbs_ack_i ({wb_s2m_dbg_ddr2_dbus_ack, wb_s2m_dbg_flash0_ack}),
    .wbs_err_i ({wb_s2m_dbg_ddr2_dbus_err, wb_s2m_dbg_flash0_err}),
    .wbs_rty_i ({wb_s2m_dbg_ddr2_dbus_rty, wb_s2m_dbg_flash0_rty}));
...
wb_arbiter
 ...
 wb_arbiter_flash0
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    .wbm_adr_i ({wb_m2s_or1k_i_flash0_adr, wb_m2s_or1k_d_flash0_adr, wb_m2s_dbg_flash0_adr}),
    .wbm_dat_i ({wb_m2s_or1k_i_flash0_dat, wb_m2s_or1k_d_flash0_dat, wb_m2s_dbg_flash0_dat}),
    .wbm_sel_i ({wb_m2s_or1k_i_flash0_sel, wb_m2s_or1k_d_flash0_sel, wb_m2s_dbg_flash0_sel}),
    .wbm_we_i  ({wb_m2s_or1k_i_flash0_we, wb_m2s_or1k_d_flash0_we, wb_m2s_dbg_flash0_we}),
    .wbm_cyc_i ({wb_m2s_or1k_i_flash0_cyc, wb_m2s_or1k_d_flash0_cyc, wb_m2s_dbg_flash0_cyc}),
    .wbm_stb_i ({wb_m2s_or1k_i_flash0_stb, wb_m2s_or1k_d_flash0_stb, wb_m2s_dbg_flash0_stb}),
    .wbm_cti_i ({wb_m2s_or1k_i_flash0_cti, wb_m2s_or1k_d_flash0_cti, wb_m2s_dbg_flash0_cti}),
    .wbm_bte_i ({wb_m2s_or1k_i_flash0_bte, wb_m2s_or1k_d_flash0_bte, wb_m2s_dbg_flash0_bte}),
    .wbm_dat_o ({wb_s2m_or1k_i_flash0_dat, wb_s2m_or1k_d_flash0_dat, wb_s2m_dbg_flash0_dat}),
    .wbm_ack_o ({wb_s2m_or1k_i_flash0_ack, wb_s2m_or1k_d_flash0_ack, wb_s2m_dbg_flash0_ack}),
    .wbm_err_o ({wb_s2m_or1k_i_flash0_err, wb_s2m_or1k_d_flash0_err, wb_s2m_dbg_flash0_err}),
    .wbm_rty_o ({wb_s2m_or1k_i_flash0_rty, wb_s2m_or1k_d_flash0_rty, wb_s2m_dbg_flash0_rty}),
    .wbs_adr_o (wb_flash0_adr_o),
    .wbs_dat_o (wb_flash0_dat_o),
    .wbs_sel_o (wb_flash0_sel_o),
    .wbs_we_o  (wb_flash0_we_o),
    .wbs_cyc_o (wb_flash0_cyc_o),
    .wbs_stb_o (wb_flash0_stb_o),
    .wbs_cti_o (wb_flash0_cti_o),
    .wbs_bte_o (wb_flash0_bte_o),
    .wbs_dat_i (wb_flash0_dat_i),
    .wbs_ack_i (wb_flash0_ack_i),
    .wbs_err_i (wb_flash0_err_i),
    .wbs_rty_i (wb_flash0_rty_i));
